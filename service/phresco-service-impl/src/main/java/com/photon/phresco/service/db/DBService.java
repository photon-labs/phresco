package com.photon.phresco.service.db;
...
public class DBService {
	...
	public List<Customer> findCustomers() {
		return template.findByNamedQuery(QUERY_ADMIN_CUSTOMERS_FIND_CUSTOMERS);
	}

	public List<Element> save(List<Element> elements) {
		template.saveOrUpdateAll(elements);
