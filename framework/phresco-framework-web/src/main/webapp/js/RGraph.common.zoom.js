    ...
    */
    RGraph.ZoomWindow = function (canvas)
    {
        ...
        */
        ...
        canvas.onmouseout = function (e)
        {
            if (RGraph.Registry.Get('chart.zoomed.div') && RGraph.Registry.Get('chart.zoomed.div').__object__.Get('chart.zoom.fade.out') && !RGraph.Registry.Get('chart.zoomed.div').__object__.Get('chart.zoom.thumbnail.fixed')) {
            ...
            } else if (!RGraph.Registry.Get('chart.zoomed.div').__object__.Get('chart.zoom.thumbnail.fixed')) {
                // Get rid of the zoom window
                if (RGraph.Registry.Get('chart.zoomed.div')) {
