...
import com.photon.maven.plugins.android.configuration.Emulator;
 ...
 *
 * @see com.photon.maven.plugins.android.configuration.Emulator
 * @see com.photon.maven.plugins.android.standalonemojos.EmulatorStartMojo
 * @see com.photon.maven.plugins.android.standalonemojos.EmulatorStopMojo
 * @see com.photon.maven.plugins.android.standalonemojos.EmulatorStopAllMojo
 * 
 */
public abstract class AbstractEmulatorMojo extends AbstractAndroidMojo {
     ...
     * @see com.photon.maven.plugins.android.configuration.Emulator#avd
     */
     ...
     * @see com.photon.maven.plugins.android.configuration.Emulator#wait
     */
     ...
     * @see com.photon.maven.plugins.android.configuration.Emulator#options
     */
