...
public interface TechnologyTypes {
     ...
     * All Technologies
     */
    List<String> ALL = Arrays.asList(PHP, PHP_DRUPAL7,PHP_DRUPAL6, ANDROID_NATIVE,ANDROID_HYBRID, ANDROID_LIBRARY, SHAREPOINT,JAVA_WEBSERVICE,NODE_JS_WEBSERVICE,HTML5_MOBILE_WIDGET,HTML5_WIDGET, DOT_NET, WORDPRESS, JAVA_STANDALONE, WIN_METRO,BLACKBERRY_HYBRID);
     ...
     */
    List<String> MOBILES = Arrays.asList(ANDROID_NATIVE, ANDROID_HYBRID, ANDROID_WEB, ANDROID_LIBRARY, IPHONE_NATIVE, IPHONE_HYBRID, IPHONE_WEB, WIN_METRO,BLACKBERRY_HYBRID);
}