 ...
 * @execute goal="clean"
 */
public class WordPressCompile extends AbstractMojo implements
	...
	protected final void compilePhpFile(File file)
			throws WordPressCompileException, CommandLineException {
		...
		if (StringUtils.isNotEmpty(bufferErrBuffer.toString())) {
			...
			throw new WordPressCompileException(commandString,
					WordPressCompileException.ERROR, file,
